	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
            ...
            <div class="form-group row">
					...
					<input type="radio" name="status" value="0"<?php if($data_cek['status']=='0') echo 'checked'?>
					/>
				<label for="sudah_m" class="col-sm-2 col-form-label">Sudah memilih</label>
				
					<input type="radio"  name="status" value="1"<?php if($data_cek['status']=='1') echo 'checked'?>
					/>
                    <label for="belum_m" class="col-sm-2 col-form-label">Belum memilih</label>
			</div>
