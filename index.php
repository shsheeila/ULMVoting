	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<b>Aplikasi Pemungutan Suara ULM berbasis Website</b>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="login.php" class="brand-link">
				<img src="images/logoulm.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light"> ULM Voting</span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=bukti-p" class="nav-link">
										<i class="nav-icon far fa-circle text-success"></i>
										<p>Bukti Pemilih</p>
									</a>
								</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
              //Klik Halaman Home Pengguna
				...
				break;
				case'bukti-p':
				include "bukti/bukti_pemilih.php";
				break;
				case'bukti-h':
				include "bukti/hapus_bukti.php";
				break;
				default:
